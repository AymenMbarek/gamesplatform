...
<textarea name="message" cols=30 rows=5 class="text-strong text-dark  "></textarea>
  ...
  <li> <input type="checkbox" id="etape3" name="etape3"><b> Envoyer demande retrait à l'admin</b></li>
</ol>
<INPUT type="submit" value="Send Mail" class="text-strong text-dark text-center center text-size-30 text-uppercase margin-bottom-20"   href="mailto:aymen199719@hotmail.Fr">

<a href="mailto:aymen199719@hotmail.Fr" onclick="    ">Send email</a>
</FORM>
<script>
...
if(x<10000)
{ 
	alert(" tu ne peux pas retirer tes points sans avoir 1000 min");
	alert("on vas te rendre dans l'acceuil dans 10 seconde");
